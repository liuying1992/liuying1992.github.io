;(function () {
  ...
  function FastClick(layer, options) {
    ...
    var methods = ['onMouse', 'onClick', 'onTouchStart', 'onTouchMove', 'onTouchEnd',
      'onTouchCancel'];
    var context = this;
  ...
  FastClick.prototype.sendClick = function (targetElement, event) {
    ...
    clickEvent.initMouseEvent(this.determineEventType(targetElement), true, true, window, 1,
        touch.screenX, touch.screenY, touch.clientX, touch.clientY, false, false, false, false, 0,
        null);
  ...
  FastClick.prototype.onTouchEnd = function (event) {
    ...
    if (deviceIsIOSWithBadTarget) {
      ...
      targetElement = document.elementFromPoint(touch.pageX - window.pageXOffset, touch.pageY
          - window.pageYOffset) || targetElement;
