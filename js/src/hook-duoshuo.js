...
typeof DUOSHUO !== 'undefined' ? hookTemplate() : ($('#duoshuo-script')[0].onload = hookTemplate);
...
function getAgentInfo(string) {
  ...
  return separator
      + '<span class="duoshuo-ua-platform duoshuo-ua-platform-'
      + osName.toLowerCase()
      + '">'
      + '<i class="fa fa-'
      + osIcon
      ...
      + '</span>'
      + separator
      + '<span class="duoshuo-ua-browser duoshuo-ua-browser-'
  ...
  function isMobile() {
    ...
    var mobileUA = ['iphone', 'android', 'phone', 'mobile', 'wap', 'netfront', 'x11', 'java',
      'opera mobi', 'opera mini', 'ucweb', 'windows ce', 'symbian', 'symbianos', 'series', 'webos',
